## -------------------------------------------------
##
## Script name: Single-variant association: superagers vs. Alzheimer's disease
##
...
##   intervals. A logistic mixed model is fit using age, sex, and top PCs as
##   covariates, with a kinship matrix from PC-Relate to account for family
##   structure.
##
## -------------------------------------------------
##
...
invisible(lapply(gds_files[roi$chr],
                 function(x) run.assoc(x, out_prefix = "assoc.sa.v.ad", subdir = "sa_v_ad", window = TRUE)))
